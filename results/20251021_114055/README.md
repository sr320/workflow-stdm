...
- **Timestamp**: 2025-10-21 11:40:57
- **Input File**: input-data/gene_expression_data.csv
- **Output Directory**: results/20251021_114055
- **Method**: TUCKER
- **Rank**: 10
...
- **Reconstruction Error**: 0.154054
- **Quality Assessment**: Good
- **Gene Factors Shape**: (10000, 10)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (10,000 × 10)
...
- **Description**: Species factor matrix (3 × 10)
...
**Reconstruction Error**: 0.154054 (Good)

The fit is good. The model captures most of the variation in the data.
