...
- **Timestamp**: 2025-11-03 09:55:18
- **Input File**: ../input-data/gene_expression_data_small.csv
- **Output Directory**: results/20251103_095518
- **Method**: PARAFAC
- **Rank**: 35

## Input Data Summary

- **Shape**: (1000, 3, 4) (genes × species × timepoints)
- **Number of Genes**: 1,000
- **Number of Species**: 3
- **Number of Timepoints**: 4
- **Sparsity**: 31.98%
- **Value Range**: [0.0000, 10.9010]
- **Mean Value**: 0.8744
- **Std Deviation**: 1.2336
...
- **Gene Factors Shape**: (1000, 35)
- **Species Factors Shape**: (3, 35)
- **Time Factors Shape**: (4, 35)
...
### 1. **gene_factors.npy**
- **Description**: Gene factor matrix (1,000 × 35)
...
- **Description**: Species factor matrix (3 × 35)
...
### 3. **time_factors.npy**
- **Description**: Time point factor matrix (4 × 35)
...
- **Description**: Reconstructed tensor from decomposition (1,000 × 3 × 4)
...
**Reconstruction Error**: 0.000000 (Excellent)

The fit is excellent. Model may be capturing all important patterns, but check for potential overfitting.
...
**Rank Selection**: Consider decreasing rank to 33 to reduce overfitting
